...
export const halls = [
  ['Hall A', 'A-01', 'A-02', 'A-03', 'A-04', 'A-05', 'A-06', 'A-07', 'A-08', 'A-09'],
  ['Hall B', 'B-01', 'B-02', 'B-03', 'B-04', 'B-05', 'B-06', 'B-07', 'B-08', 'B-09'],
]
...
export type LandingIconName = (typeof features)[number]['icon'] | 'apple' | 'ticket'
